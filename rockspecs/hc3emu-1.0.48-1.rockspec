...
source = {
   ...
   tag = "v1.0.48", -- updated tag to match version
}
description = {
...
build = {
   ...
   modules = {
      ...
      ["hc3emu.scene"] = "src/scene.lua",
      ["hc3emu.sceneengine"] = "src/sceneengine.lua",
      ["hc3emu.refreshstate"] = "src/refreshstate.lua",
      ["hc3emu.event"] = "src/event.lua",
      ["hc3emu.lib"] = "src/lib.lua",
      ["hc3emu.sourcetrigger"] = "src/sourcetrigger.lua",
      ["hc3emu.QwikChild"] = "src/QwikChild.lua",
